...
'''
    ...
    def lambda_function_exists(self, name):
        # type: (str) -> bool
        try:
            self.get_client('lambda').get_function(FunctionName=name)
    ...
    def update_function_code(self, function_name, zip_contents):
        # type: (str, str) -> None
        self.get_client('lambda').update_function_code(
...
'''
    ...
    def region_name(self):
        # type: () -> str
        return self.get_client('apigateway').meta.region_name
    ...
    def get_rest_api_id(self, name):
        ...
        """
        rest_apis = self.get_client('apigateway').get_rest_apis()['items']
    ...
    def create_rest_api(self, name):
        # type: (str) -> str
        response = self.get_client('apigateway').create_rest_api(name=name)
        return response['id']
    ...
    def get_resources_for_api(self, rest_api_id):
        ...
        client = self.get_client('apigateway')
    ...
    def get_sdk_download_stream(self, rest_api_id, stage='dev',
        ...
        generated SDK.
        """
        response = self.get_client('apigateway').get_sdk(
...
'''
    def get_role_arn_for_name(self, name):
        # type: (str) -> str
        try:
            role = self.get_client('iam').get_role(RoleName=name)
        except botocore.exceptions.ClientError as e:
            error = e.response['Error']
    ...
    def delete_role_policy(self, role_name, policy_name):
        # type: (str, str) -> None
        self.get_client('iam').delete_role_policy(RoleName=role_name,
                                               PolicyName=policy_name)

    def put_role_policy(self, role_name, policy_name, policy_document):
        # type: (str, str, Dict[str, Any]) -> None
        # Note: policy_document is not JSON encoded.
        self.get_client('iam').put_role_policy(
            RoleName=role_name,
            PolicyName=policy_name,
